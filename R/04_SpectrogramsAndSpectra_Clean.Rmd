---
title: "Create and Save Cleaned Spectrograms"
author: "Sarah Shiers"
date: "2025-09-25"
...
2.  **Load in acoustic study from an RDS file and Gg times from log**
    ...
    #For generating new visuals use the following
            ...
            data <- processPgDetections(pps, mode='db',id=DriftID)
        
            saveRDS(data, paste0(baseDir,'AcousticStudies/',DriftID,'_Gg_clean.rds'))
            beep()
...
for (k in seq_along(event_ids)) {
  ...
  spg_dst  <- fs::path(ev_dir, paste0("Event_", suffix, "_Spectrogram_Clean.png"))
  spec_dst <- fs::path(ev_dir, paste0("Event_", suffix, "_Spectrum_Clean.png"))
